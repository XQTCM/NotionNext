...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'DrWangXQ', // 您的昵称 例如 xqtcm
  BIO: process.env.NEXT_PUBLIC_BIO || '一个经络迷🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://jingluomi.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Jingluomi, 经络迷', // 网站关键词 英文逗号隔开
